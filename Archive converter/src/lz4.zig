...
pub const struct_LZ4_stream_t_internal = extern struct {
    hashTable: [4096]LZ4_u32 = @import("std").mem.zeroes([4096]LZ4_u32),
    dictionary: [*c]const LZ4_byte = @import("std").mem.zeroes([*c]const LZ4_byte),
    dictCtx: [*c]const LZ4_stream_t_internal = @import("std").mem.zeroes([*c]const LZ4_stream_t_internal),
    currentOffset: LZ4_u32 = @import("std").mem.zeroes(LZ4_u32),
    tableType: LZ4_u32 = @import("std").mem.zeroes(LZ4_u32),
    dictSize: LZ4_u32 = @import("std").mem.zeroes(LZ4_u32),
};
...
pub const LZ4_streamDecode_t_internal = extern struct {
    externalDict: [*c]const LZ4_byte = @import("std").mem.zeroes([*c]const LZ4_byte),
    prefixEnd: [*c]const LZ4_byte = @import("std").mem.zeroes([*c]const LZ4_byte),
    extDictSize: usize = @import("std").mem.zeroes(usize),
    prefixSize: usize = @import("std").mem.zeroes(usize),
};
...
pub const LZ4LIB_VISIBILITY = @compileError("unable to translate macro: undefined identifier `visibility`");
// /usr/include/lz4.h:87:13
pub const LZ4LIB_API = LZ4LIB_VISIBILITY;
pub const LZ4_FREESTANDING = @as(c_int, 0);
...
pub const LZ4_QUOTE = @compileError("unable to translate C expr: unexpected token '#'");
// /usr/include/lz4.h:138:9
...
pub const LZ4_MAX_INPUT_SIZE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7E000000, .hex);
pub inline fn LZ4_COMPRESSBOUND(@"isize": anytype) @TypeOf(if (@import("std").zig.c_translation.cast(c_uint, @"isize") > @import("std").zig.c_translation.cast(c_uint, LZ4_MAX_INPUT_SIZE)) @as(c_int, 0) else (@"isize" + @import("std").zig.c_translation.MacroArithmetic.div(@"isize", @as(c_int, 255))) + @as(c_int, 16)) {
    _ = &@"isize";
    return if (@import("std").zig.c_translation.cast(c_uint, @"isize") > @import("std").zig.c_translation.cast(c_uint, LZ4_MAX_INPUT_SIZE)) @as(c_int, 0) else (@"isize" + @import("std").zig.c_translation.MacroArithmetic.div(@"isize", @as(c_int, 255))) + @as(c_int, 16);
}
...
// /usr/lib/zig/include/stdint.h:326:9
...
pub const LZ4_DEPRECATED = @compileError("unable to translate macro: undefined identifier `deprecated`");
// /usr/include/lz4.h:755:13
